...
export interface CloudSunRainIconHandle {
 startAnimation: () => void;
 stopAnimation: () => void;
}

interface CloudSunRainIconProps extends Omit<
...
const CloudSunRainIcon = forwardRef<
 CloudSunRainIconHandle,
 CloudSunRainIconProps
>(
 (
  {
   onMouseEnter,
